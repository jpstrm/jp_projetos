...
public class TratandoExcecoes {
	...
	public static void main (String[] args)
	{
		...
		JOptionPane.showMessageDialog(null, "Dia do Mês: " + calendario.get(Calendar.DAY_OF_MONTH));
		Date data = new Date();*/
		...
		do {
			try {
				...
				divisao = num / den;
				JOptionPane.showMessageDialog(null, "A divisão é: " + df.format(divisao));
				continua = false;
			...
			{
				JOptionPane.showMessageDialog(null, "O denominador tem que ser um número inteiro");
			}
		} while (continua);
		//JOptionPane.showMessageDialog(null, "A hora é: " + data);
